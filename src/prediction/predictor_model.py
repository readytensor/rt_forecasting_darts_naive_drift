...
class Forecaster:
    """A wrapper class for the NaiveDrift Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "NaiveDrift Forecaster"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Construct a new NaiveDrift Forecaster
        ...
        Args:
            ...
            input_chunk_length (int): The size of the sliding window used to calculate the moving average
    ...
    def fit(
        ...
        A separate NaiveDrift model is fit to each series that is contained
        in the data.
    ...
    def _fit_on_series(self, history: pd.DataFrame, data_schema: ForecastingSchema):
        """Fit NaiveDrift model to given individual series of data"""
        model = NaiveDrift()
